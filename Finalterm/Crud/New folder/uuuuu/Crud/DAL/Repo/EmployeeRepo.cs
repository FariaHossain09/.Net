...
namespace DAL.Repo
{
    public  class EmployeeRepo : IRepo<employee, int, bool>, IAuth<employee>
    {
        fund_dbEntities db;
        ...
        {
            return db.employees.FirstOrDefault(u => u.eUserName.Equals(username)
            && u.ePassword.Equals(password));
